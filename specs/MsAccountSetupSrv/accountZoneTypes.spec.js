...
describe("AccountZoneTypes.spec tests. | ", function() {
  // ** START BEFORE EACH.
  ...
  it("Validate getting AccountZoneTypes", function(done) {
    request.get({
        url: config.SseServicesCmsCORS + "MsAccountSetupSrv/MonitoringStationOS/MI_DICE/AccountZoneTypes",
        json: true
      },
