        ...
        dataSource.createMsAccount(request, {
          ...
          request.post({
            ...
            request.post({
              ...
              request.get({
                url: config.SseServicesCmsCORS + "InvoiceSrv/InvoiceItems/" + bodyIn1.Value.InvoiceItemID + "/Delete",
                json: true
              }, function(error, response, bodyIn2) {
                // console.log("Body: ", bodyIn2);
                expect(error).toBeNull();
                ...
                request.post({
                  ...
                  // console.log("Body: ", bodyByPartNumber);
                  ...
                  request.post({
                    ...
                    expect(bodyByBarcode.Value.Items[2].ProductBarcodeId).toBe(barcodeId, "BarcodeId did not return the correct one.");
